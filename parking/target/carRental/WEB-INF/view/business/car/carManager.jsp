    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="isrenting" value="1" title="已停入">
                <input type="radio" name="isrenting" value="0" title="未停入">
            </div>
            <button type="button"
    ...
    <form class="layui-form layui-row layui-col-space10" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="layui-row layui-col-space10">
                ...
                <div class="layui-col-md3 layui-col-xs5" style="display: none">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block" style="padding: 5px">
                        <input type="text" name="rentprice" class="layui-input" lay-verify="required|number"
                               placeholder="请输入停车费" style="height: 30px;border-radius: 10px">
                    </div>
                </div>
            </div>
            <div class="layui-form-item magb0">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block" style="padding: 5px">
                        <input type="text" name="deposit" class="layui-input" lay-verify="required|number"
                               placeholder="请输入押金" style="height: 30px;border-radius: 10px">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">是否停车:</label>
                    <div class="layui-input-inline">
                        <input type="radio" name="isrenting" value="1" title="已停入">
                        <input type="radio" name="isrenting" value="0" checked="checked" title="未停入">
                    </div>
                </div>
            </div>
            <div class="layui-form-item magb0">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'rentprice', title: '停车费', align: 'center', width: '90'}
                , {field: 'deposit', title: '押金', align: 'center', width: '90'}
                , {
                    field: 'isrenting', title: '当前状态', align: 'center', width: '90', templet: function (d) {
                        return d.isrenting == '1' ? '<font color=blue>已停入</font>' : '<font color=red>未停入</font>';
                    }
                }
