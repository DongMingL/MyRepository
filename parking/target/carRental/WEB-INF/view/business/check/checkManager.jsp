        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="checkid" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入缴费单号" style="height: 30px;border-radius: 10px;width: 280px">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">车位单号:</label>
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="rentid" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入车位单号" style="height: 30px;border-radius: 10px;width: 280px">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="startTime" id="startTime" readonly="readonly"
                       ...
                       placeholder="请输入车辆停入时间" style="height: 30px;border-radius: 10px;width: 280px">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="endTime" id="endTime" readonly="readonly"
                       class="layui-input layui-input-inline"
                       placeholder="请输入车辆停出时间" style="height: 30px;border-radius: 10px;width: 280px">
            </div>
        </div>
    </div>
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="checkid" lay-verify="required" readonly="readonly" placeholder="请输入缴费单号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">车位单号:</label>
            <div class="layui-input-block">
                <input type="text" name="rentid" lay-verify="required" readonly="readonly" placeholder="请输入车位单号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
           <%-- <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="paymoney" lay-verify="required"  placeholder="请输入缴费金额" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'checkid', title: '缴费单号', align: 'center', width: '257'}
                , {field: 'rentid', title: '车位单号', align: 'center', width: '260'}
                , {field: 'paymoney', title: '缴费金额', align: 'center', width: '100'}
                , {field: 'opername', title: '操作员', align: 'center', width: '100'}
                , {field: 'checkdate', title: '停车时间', align: 'center', width: '180'}
        ...
        table.on("toolbar(checkTable)",function (obj) {
            ...
            if (layEvent==='deleteBatch'){
                ...
                layer.confirm('真的要删除这些缴费单吗？',function (index) {
                    //向服务端发送删除指令
        ...
        table.on('tool(checkTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.checkid + '】这个缴费单么？', function (index) {
                    //向服务端发送删除指令
