...
<form class="layui-form" method="post" id="searchFrm">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="rentid" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入车位编号" style="height: 30px;border-radius: 10px">
            </div>
        </div>
       <%-- <div class="layui-inline">
   ...
   <%-- <div class="layui-form-item">
        ...
        <div class="layui-inline" style="margin-left: 300px;margin-top: -60px">
            <label class="layui-form-label">车位状态:</label>
            <div class="layui-input-inline">
                <input type="radio" name="rentflag" value="1" title="已占用">
                <input type="radio" name="rentflag" value="0" title="未占用">
            </div>
            <button type="button"
...
<script type="text/html" id="rentBar">
    {{#  if(d.rentflag == 1){ }}
    <a class="layui-btn layui-btn-green layui-btn-xs layui-btn-radius" lay-event="exportRent">导出车位单</a>
    {{#  } else { }}
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="rentid" lay-verify="required" readonly="readonly" placeholder="请输入车位编号"
                       class="layui-input">
            </div>
        </div>
       <%-- <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , page: true  //是否启用分页
            , cols: [[   //列表数据
                , {field: 'rentid', title: '车位编号', align: 'center', width: '259'}
                , {field: 'price', title: '出租价格', align: 'center', width: '90'}
                , {
                    field: 'rentflag', title: '车位状态', align: 'center', width: '100', templet: function (d) {
                        return d.rentflag == '1' ? '<font color=blue>已占用</font>' : '<font color=red>未占用</font>';
                    }
                }
        ...
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个车位么？', function (index) {
                    //向服务端发送删除指令
